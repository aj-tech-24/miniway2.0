      ...
      >
        <SafeAreaView style={styles.modalContainer}>
          ...
          >
            ...
            <Text style={styles.paragraph}>
              4.1. <Text style={styles.bold}>Commuters</Text>: Can search for
              routes, track buses, and request pickups.
            </Text>
            <Text style={styles.paragraph}>
              4.2. <Text style={styles.bold}>Drivers</Text>: Can manage trips,
              update location, and accept passenger requests.
            </Text>
            <Text style={styles.paragraph}>
            ...
            <Text style={styles.paragraph}>
              5.1. Fares are determined by the service operators and may vary by
              route and time.
            </Text>
            <Text style={styles.paragraph}>
            ...
            <Text style={styles.paragraph}>
              5.3. Refunds are handled on a case-by-case basis according to our
              refund policy.
            </Text>

            <Text style={styles.sectionTitle}>6. Location Services</Text>
            <Text style={styles.paragraph}>
              6.1. Our app uses GPS and location services to provide real-time
              tracking.
            </Text>
            <Text style={styles.paragraph}>
              6.2. By using our service, you consent to the collection and use
              of location data as described in our Privacy Policy.
            </Text>
            <Text style={styles.paragraph}>
              6.3. Location accuracy may vary depending on device and network
              conditions.
            </Text>
            ...
            <Text style={styles.paragraph}>
              8.1. All users are expected to prioritize safety while using the
              service.
            </Text>
            <Text style={styles.paragraph}>
              8.2. Drivers must comply with all traffic laws and regulations.
            </Text>
            <Text style={styles.paragraph}>
              8.3. Report any safety concerns or incidents immediately through
              the app.
            </Text>

            <Text style={styles.sectionTitle}>9. Privacy</Text>
            <Text style={styles.paragraph}>
              Your use of Miniway is also governed by our Privacy Policy, which
              describes how we collect, use, and protect your personal
              information. Please review the Privacy Policy to understand our
              practices.
            </Text>

            <Text style={styles.sectionTitle}>10. Intellectual Property</Text>
            <Text style={styles.paragraph}>
              10.1. All content, features, and functionality of the Miniway app
              are owned by us and are protected by copyright, trademark, and
              other intellectual property laws.
            </Text>
            <Text style={styles.paragraph}>
              10.2. You may not copy, modify, distribute, or create derivative
              works without our express written permission.
            </Text>

            <Text style={styles.sectionTitle}>11. Disclaimers</Text>
            <Text style={styles.paragraph}>
              11.1. The service is provided &#34;as is&#34; without warranties of any
              kind.
            </Text>
            <Text style={styles.paragraph}>
            ...
            <Text style={styles.paragraph}>
              11.3. We are not responsible for delays, cancellations, or route
              changes by service operators.
            </Text>
            <Text style={styles.paragraph}>
              11.4. We do not guarantee the accuracy of real-time location data.
            </Text>
            ...
            <Text style={styles.paragraph}>
              13.1. We reserve the right to suspend or terminate your account at
            ...
            <Text style={styles.paragraph}>
              ...
              in-app notification. Continued use of the service after changes
            ...
            <Text style={styles.paragraph}>
              ...
              accordance with the laws of Kenya, without regard to its conflict
              of law provisions.
            </Text>
            ...
            <Text style={styles.paragraph}>Email: support@miniway.co.ke</Text>
